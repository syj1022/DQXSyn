...
st.title("🔬 Gibbs Energy-Based Structure Ranking")

T = st.slider("Temperature (K)", 300, 2000, 1000, step=50)
col1, col2 = st.columns(2)
with col1:
    CaO = st.slider("CaO molar ratio", 0.01, 10.0, 1.0)
    MgO = st.slider("MgO molar ratio", 0.01, 10.0, 1.0)
with col2:
    SiO2 = st.slider("SiO₂ molar ratio", 0.01, 10.0, 1.0)
    O2 = st.slider("O₂ molar ratio", 0.01, 10.0, 1.0)
